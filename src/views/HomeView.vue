      ...
      <section id="intro" class="s-intro target-section">
        ...
        <div class="s-intro__content-media">
          <img src="@/assets/images/intro-bg.jpg"
            srcset="@/assets/images/intro-bg.jpg 1x, @/assets/images/intro-bg.jpg 2x" alt="">
        ...
        <div class="row s-about__content">
          <div class="column xl-12">
            ...
            <p class="attention-getter">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas explicabo id debitis cupiditate cumque,
              error quia! Debitis cupiditate ipsa nihil labore, earum atque dolor quos saepe vero inventore, odit nam
              deleniti accusantium omnis mollitia consequatur harum incidunt! Ex modi aut repudiandae doloremque commodi
              recusandae labore sit. Perspiciatis omnis dolor dolores fuga iusto, recusandae animi nisi consequuntur
              exercitationem id maxime earum pariatur voluptas! Porro non quos quae tempora fuga quis sequi minus sed
              sint debitis reiciendis, nostrum natus suscipit iusto odio.
            </p>

            <p class="attention-getter">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
              dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex
              ea commodo consequat. Duis aute irure dolor in reprehenderit. Ut enim ad minim
            </p>
      ...
      <section id="works" class="s-works target-section">
        ...
        <div class="row folio-entries">
          ...
          <div class="column entry">
            <a href="@/assets/images/folio/gallery/g-turban.jpg" class="entry__link glightbox"
              data-glightbox="title: White Knit Cap; description: .entry__desc-01">
              <div class="entry__thumb">
                <img src="@/assets/images/folio/white_turban.jpg"
                  srcset="@/assets/images/folio/white_turban.jpg 1x, @/assets/images/folio/white_turban@2x.jpg 2x"
                  alt="">
              </div>
          ...
          <div class="column entry">
            <a href="@/assets/images/folio/gallery/g-woodcraft.jpg" class="entry__link glightbox"
              data-glightbox="title: WoodCraft; description: .entry__desc-02">
              <div class="entry__thumb">
                <img src="@/assets/images/folio/woodcraft.jpg"
                  srcset="@/assets/images/folio/woodcraft.jpg 1x, @/assets/images/folio/woodcraft@2x.jpg 2x" alt="">
              </div>
              <div class="entry__info">
          ...
          <div class="column entry">
            <a href="@/assets/images/folio/gallery/g-tulips.jpg" class="entry__link glightbox"
              data-glightbox="title: Caffeine & Tulips; description: .entry__desc-03">
              <div class="entry__thumb">
                <img src="@/assets/images/folio/caffeine_and_tulips.jpg"
                  srcset="@/assets/images/folio/caffeine_and_tulips.jpg 1x, @/assets/images/folio/caffeine_and_tulips@2x.jpg 2x"
                  alt="">
              </div>
              <div class="entry__info">
          ...
          <div class="column entry">
            <a href="@/assets/images/folio/gallery/g-grayscale.jpg" class="entry__link glightbox"
              data-glightbox="title: Grayscale; description: .entry__desc-04">
              <div class="entry__thumb">
                <img src="@/assets/images/folio/grayscale.jpg"
                  srcset="@/assets/images/folio/grayscale.jpg 1x, @/assets/images/folio/grayscale@2x.jpg 2x" alt="">
              </div>
              <div class="entry__info">
          ...
          <div class="column entry">
            <a href="@/assets/images/folio/gallery/g-lamp.jpg" class="entry__link glightbox"
              data-glightbox="title: The Lamp; description: .entry__desc-05">
              <div class="entry__thumb">
                <img src="@/assets/images/folio/lamp.jpg"
                  srcset="@/assets/images/folio/lamp.jpg 1x, @/assets/images/folio/lamp@2x.jpg 2x" alt="">
              </div>
              <div class="entry__info">
          ...
          <div class="column entry">
            <a href="@/assets/images/folio/gallery/g-tropical.jpg" class="entry__link glightbox"
              data-glightbox="title: Tropical; description: .entry__desc-06">
              <div class="entry__thumb">
                <img src="@/assets/images/folio/tropical.jpg"
                  srcset="@/assets/images/folio/tropical.jpg 1x, @/assets/images/folio/tropical@2x.jpg 2x" alt="">
              </div>
              <div class="entry__info">
              ...
              <div class="swiper-wrapper">
                ...
                <div class="s-testimonials__slide swiper-slide">
                  <div class="s-testimonials__author">
                    <img src="@/assets/images/avatars/user-02.jpg" alt="Author image" class="s-testimonials__avatar">
                  ...
                  <p>
                    ...
                    Explicabo a quaerat sint autem dolore ducimus ut consequatur neque. Nisi dolores quaerat fuga rem
                    nihil nostrum.
                ...
                <div class="s-testimonials__slide swiper-slide">
                  <div class="s-testimonials__author">
                    <img src="@/assets/images/avatars/user-03.jpg" alt="Author image" class="s-testimonials__avatar">
                    <cite class="s-testimonials__cite">
                ...
                <div class="s-testimonials__slide swiper-slide">
                  <div class="s-testimonials__author">
                    <img src="@/assets/images/avatars/user-01.jpg" alt="Author image" class="s-testimonials__avatar">
                    <cite class="s-testimonials__cite">
                  ...
                  <p>
                    Repellat dignissimos libero. Qui sed at corrupti expedita voluptas odit. Nihil ea quia nesciunt.
                ...
                <div class="s-testimonials__slide swiper-slide">
                  <div class="s-testimonials__author">
                    <img src="@/assets/images/avatars/user-06.jpg" alt="Author image" class="s-testimonials__avatar">
                    <cite class="s-testimonials__cite">
                  ...
                  <p>
                    ...
                    quis tortor malesuada pretium. Curabitur vestibulum aliquam leo. Qui sed at corrupti expedita
                    voluptas odit.
        ...
        <div class="row s-footer__bottom">
          ...
          <div class="column xl-6 lg-12">
            <p class="ss-copyright">
              ...
              <span>Design by <a href="https://styleshout.com/">StyleShout</a> Distribution by <a
